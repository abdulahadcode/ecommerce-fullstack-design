...
const Navigation = () => {
  ...
  return (
    <div className="hidden w-full max-w-[1200px] mx-auto lg:flex border-b border-gray-200 py-5 px-4">
      <div className="container flex flex-wrap items-center justify-between text-sm w-[77vw] mx-auto py-10px">
        ...
        <div className="flex flex-wrap items-center gap-4 md:gap-8 text-black font-medium">
          ...
          <a href="#" className="hover:text-blue-600 transition flex items-center gap-1.5">Help
            <svg
